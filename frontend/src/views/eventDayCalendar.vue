<template>
  ...
  <button v-if="event.author === currentUser" @click="confirmDeleteEvent(event._id)" class="delete-btn" style="bottom: 20px;">🗑️ Elimina Evento</button>
      ...
      <div class="section activities-section">
        ...
        <div v-if="activities.length > 0">
          ...
          :class="{ completed: activity.completed }">
            ...
            <button @click="confirmDeleteActivity(activity._id)" class="delete-btn" style="bottom: 20px;">🗑️</button>
          </div>
        </div>
